...
//        assertEquals(Expected, HexGridMapPosition.calculateVectorCoordinate(targetX, targetY));
//        targetX = 3;
//        targetY = 4;
...
//    }
    ...
    public void dynamicHexagonSizeTest(){
        ...
        assertEquals(Expected, HexGridMapPosition.calculateVectorCoordinate(position));
